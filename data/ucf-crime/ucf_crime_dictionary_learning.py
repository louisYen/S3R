...
class DictArgumentParser(Tap):
    ...
    dataset: Literal['shanghaitech', 'ucf-crime', 'xd-violence'] = 'ucf-crime' # dataset to train
...
def dictionary_learning(
        ...
        ratio: int = 50, # the ratio for keeping the number of slots (default: 50)
